...
export const works: Work[] = [
    {
        ...
        videos: [
            { id: 'dTK1UmPL8Rw', title: '「オリオン」2025 牟岐町プロモーション動画' },
    ...
    },
    {
        ...
        gallery: [
            ...
            '/images/works/mugizine/7.jpg',
            '/images/works/mugizine/8.jpg',
            '/images/works/mugizine/9.jpg',
            '/images/works/mugizine/10.jpg'
        ]
    },
    {
    ...
    },
    {
        ...
        year: '2021-',
        client: '松茂町（徳島）',
        produce: 'プロデュース 中川みどり（1 on G / ABOUT BETTER PLACE）',
        produceLink: 'https://www.aboutbetterplace.com/',
        role: 'ディレクション / 撮影 / 編集',
        tools: 'Sony α7SⅢ / Premiere Pro',
        ...
        result: '公開された映像は、Webサイトを通じて広く発信され、プロジェクトの認知度向上に大きく貢献しました。視聴者からは「制作の裏側を見ることで、作品への愛着が湧いた」「松茂町にこんなにクールな場所があるのかと驚いた」といった声が寄せられています。\n記録映像としての枠を超え、次なるアートイベントへの期待感を醸成する「動くポートフォリオ」として、町のブランディングの一翼を担う成果となりました。',
    ...
    {
        slug: 'tokushima-sdgs-ethical-series',
        title: '徳島県 SDGs取組紹介映像シリーズ',
        type: 'work',
        category: 'Interview / Documentary',
        color: 'color-7',
        image: 'https://img.youtube.com/vi/zv3WFoTQOOs/maxresdefault.jpg',
        year: '2022',
        client: '徳島県',
        role: '撮影 / 編集 / 構成',
        tools: 'Sony α7SⅢ / Premiere Pro',
        overview: '徳島県の公式YouTube「徳島県チャンネル」で公開されている、エシカル消費に取り組む県内の企業・学校・団体を紹介する映像シリーズです。取材をもとにした構成・撮影・編集を担当し、シリーズ計7本を制作しました。掲載しているのは、喜多機械産業株式会社の取り組みを紹介した回です。',
        process: '各回とも現場での取材を軸に構成。取り組みの当事者の言葉をインタビューで記録し、実際の活動風景を織り交ぜることで、「エシカル消費」という抽象度の高いテーマを、短い尺でも具体的に伝わる形にまとめました。シリーズ全体でトーンを揃えながら、企業・学校それぞれの現場の空気が残るよう編集しています。',
        result: '徳島県の公式チャンネルで公開され、県のエシカル消費の普及啓発に広報素材として活用されています。行政の広報映像を、堅くなりすぎず現場の温度感を保ったまま届けるシリーズとなりました。',
        youtubeId: 'zv3WFoTQOOs'
    },
    {
        slug: 'hotel-shu-visual',
        title: 'ホテル聚（Hotel SHU）ビジュアル',
        type: 'work',
        category: 'Visual Direction / Photography',
        color: 'color-2',
        image: '/images/works/hotel-shu.png',
        year: '2025-',
        client: '株式会社アミューズ',
        role: 'ビジュアル担当（撮影・映像）',
        tools: 'Sony α7SⅢ / Lightroom / Premiere Pro',
        overview: '香川県・豊島（てしま）の家浦の集落に2026年4月に開業する宿「ホテル聚（Hotel SHU）」。「『豊島の暮らし』に泊まる」をコンセプトに、訪れた人と住まう人の境界を曖昧にしていく宿の、ビジュアルを担当しています。開業に先立ち、Instagramを中心に、島の暮らしと宿の空気を伝える写真・映像を継続的に制作しています。',
        process: '豊島では映像作品「香川県豊島・国境を越えて・祈り」も手がけており、同じ島で撮り続けてきた空気感の延長でビジュアルを設計。島の光と季節、集落の日常の質感が伝わる撮影を重ね、開業前の段階から世界観を揃えて積み上げることで、宿のブランドの土台をつくっています。',
        result: '開業前から、Instagramを通じて宿のコンセプトと豊島の暮らしを伝える発信が続いています。単発の撮影ではなく、開業に向けて見え方を育てていく継続的なビジュアル運用として進行中です。',
        link: 'https://www.instagram.com/hotelshu/',
        linkLabel: 'Instagram',
        linkButtonText: 'View Instagram',
    },
];
