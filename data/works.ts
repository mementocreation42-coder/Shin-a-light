...
export const works: Work[] = [
    {
        ...
        overview: '徳島県南部、豊かな海と山に囲まれた牟岐町の魅力を内外に発信するプロモーション映像制作。単なる観光スポットの紹介に留まらず、そこに流れる「時間の豊かさ」や「人々の暮らしの温度感」を可視化することを目的としています。 移住検討者や観光客に向けて、牟岐町特有の空気感をシネマティックに切り取り、「訪れたい場所」から「戻ってきたい場所」へと意識を繋げるストーリー構成を意識しました。',
        ...
        result: '公開後、町内外の方々から「見慣れた景色がこれほどまでに美しいとは再発見だった」「牟岐の静かな力強さが伝わる」といった多くの反響をいただきました。 自治体の公式プロモーションとしての活用だけでなく、移住相談窓口やSNSでも広く拡散され、町のブランドイメージ向上に寄与。映像を通じて、牟岐町という土地が持つ「本質的な価値」を言語化・視覚化する一助となりました。',
        videos: [
            { id: 'paU7-HBI7Ng', title: '牟岐町プロモーション Vol.02' },
            { id: 'EVK8c50jFCU', title: '牟岐町プロモーション Vol.03' }
        ]
    },
    {
