...
export const works: Work[] = [
    ...
    },
    {
        ...
        title: '家族ドキュメンタリー MEMENTO',
        category: 'Family Documentary / MEMENTO',
        color: 'color-7',
        image: 'https://picsum.photos/seed/memento/800/450',
        year: '2022',
        client: 'オウンドサービス',
        role: 'プロデュース / 撮影 / 編集',
        tools: 'ANYWHERE',
        overview: '娘が生まれたことで、世界の見え方が一変しました。 刻一刻と変化していく表情や、二度と戻らない何気ない日常の断片を、単なる「記録データ」としてではなく、未来の彼女へ贈る「手紙」のような映像として残したい。そんな個人的な衝動からこのプロジェクトは始まりました。\n\n本プロジェクトの目的は、家族の歴史を「消費されるコンテンツ」から「時を越えて愛される資産（MEMENTO）」へと昇華させることにあります。',
        process: 'ビデオグラファー、フォトグラファーとしての技術を「作品づくり」のためではなく、徹底的に「対象への眼差し」のために注ぎ込みました。\n\n自然体の追求：\n作り込まれたセットやポーズではなく、生活の音、光の移ろい、言葉にならない空気感を掬い取るドキュメンタリー手法を採用。\n\n視点の設計：\n親としての主観的な愛情と、クリエイターとしての客観的な構図を融合。何十年後に見返しても、当時の「温度」が肌に蘇るような質感を追求しました。\n\n非言語の物語：\nライターとしての経験を活かし、テロップやナレーションに頼らずとも、映像の繋ぎと間（ま）だけで感情が伝わるエディトリアルな編集を施しています。',
        result: '完成した映像は、家族にとってかけがえのない宝物となっただけでなく、試写した周囲の親世代からも「自分たちもこういう形で残したかった」という深い共感の声を多くいただきました。\n\nこのプロジェクトを通じて、**「誰かの人生の核心にある想いを可視化する」**という、自身の制作活動における一貫したフィロソフィーを再定義するきっかけとなりました。現在は、このコンセプトをベースとした家族映像制作の仕組み化や、パーソナルな物語を資産化する試みを継続しています。',
        gallery: [
            'https://picsum.photos/seed/memento/800/450',
            'https://picsum.photos/seed/mem1/800/450',
            'https://picsum.photos/seed/mem2/800/450'
        ]
    },
];
