...
export const universeLinks: UniverseLink[] = [
    ...
    {
        title: 'SAL Stack',
        url: 'https://substack.com/@saldaisukekobayashi',
        description: '映像・写真・健康・AI・自然、暮らしのヒントを届けるSALのSubstack',
        tags: ['web', 'ai', 'health'],
        domain: 'substack.com',
        gradient: 'linear-gradient(135deg, #ff6719 0%, #cc4400 100%)',
        accent: '#ff6719',
        glyph: 'S',
        section: 'sns',
    },
    {
        title: 'enigamid',
        url: 'https://www.instagram.com/enigamid/',
        description: '映像・写真・釣り・日常——SAL Daisuke KobayashiのInstagram',
        tags: ['photo', 'video'],
